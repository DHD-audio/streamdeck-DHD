...
rm -r "$HOME/Library/Application Support/com.elgato.StreamDeck/Plugins/audio.dhd.rm1.sdPlugin"

cp -a src/audio.dhd.rm1.sdPlugin/ "$HOME/Library/Application Support/com.elgato.StreamDeck/Plugins/audio.dhd.rm1.sdPlugin"
